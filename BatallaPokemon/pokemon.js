...
let pokemonListDiv = document.getElementById('elegir-pokemon');

function generarAleatorio() {
    let pokemonJugador = pokemons[Math.floor(Math.random() * pokemons.length)];
    let pokemonRival = pokemons[Math.floor(Math.random() * pokemons.length)];
    let shinyRivalProbabilidad = Math.ceil(Math.random() * 20) + 1;
    if (shinyRivalProbabilidad == 4) {
        pokemonRival.img = pokemonRival.img.replace("normal", "shiny");
        pokemonRival.isShiny = true;
    }
    localStorage.setItem('selectedPokemon', JSON.stringify(pokemonJugador));
    localStorage.setItem('pokemonRival', JSON.stringify(pokemonRival));
    window.location.href = 'pantallaPokemons.html';
}
...
function mostrarPokemons() {
    for (let i = 0; i < pokemons.length; i++) {
        ...
        let tipo2 = pokemon.types[1];
        const shinyProbabilidad = Math.ceil(Math.random() * 20) + 1;
        let shiny = false;
        if (shinyProbabilidad==4) {
            shiny = true;
        }

        if (tipo2) {
            if (tipo == "Grass" && tipo2 == "Poison") {
                pokemonDiv.classList.add('grassPoison');
            }
            if (tipo == "Fire" && tipo2 == "Flying") {
                pokemonDiv.classList.add('fireFlying');
            }
            if (tipo == "Bug" && tipo2 == "Flying") {
                pokemonDiv.classList.add('bugFlying');
            }
            if (tipo == "Bug" && tipo2 == "Poison") {
                pokemonDiv.classList.add('bugPoison');
            }
            if (tipo == "Normal" && tipo2 == "Flying") {
                pokemonDiv.classList.add('normalFlying');
            }
            if (tipo == "Poison" && tipo2 == "Ground") {
                pokemonDiv.classList.add('poisonGround');
            }
            if (tipo == "Normal" && tipo2 == "Fairy") {
                pokemonDiv.classList.add('normalFairy');
            }
            if (tipo == "Poison" && tipo2 == "Flying") {
                pokemonDiv.classList.add('poisonFlying');
            }
            if (tipo == "Bug" && tipo2 == "Grass") {
                pokemonDiv.classList.add('bugGrass');
            }
            if (tipo == "Water" && tipo2 == "Fighting") {
                pokemonDiv.classList.add('waterFighting');
            }
            if (tipo == "Water" && tipo2 == "Poison") {
                pokemonDiv.classList.add('waterPoison');
            }
            if (tipo == "Rock" && tipo2 == "Ground") {
                pokemonDiv.classList.add('rockGround');
            }
            if (tipo == "Water" && tipo2 == "Psychic") {
                pokemonDiv.classList.add('waterPsychic');
            }
            if (tipo == "Electric" && tipo2 == "Steel") {
                pokemonDiv.classList.add('electricSteel');
            }
            if (tipo == "Water" && tipo2 == "Ice") {
                pokemonDiv.classList.add('waterIce');
            }
            if (tipo == "Ghost" && tipo2 == "Poison") {
                pokemonDiv.classList.add('ghostPoison');
            }
            if (tipo == "Grass" && tipo2 == "Psychic") {
                pokemonDiv.classList.add('grassPsychic');
            }
            if (tipo == "Ground" && tipo2 == "Rock") {
                pokemonDiv.classList.add('groundRock');
            }
            if (tipo == "Psychic" && tipo2 == "Fairy") {
                pokemonDiv.classList.add('psychicFairy');
            }
            if (tipo == "Ice" && tipo2 == "Psychic") {
                pokemonDiv.classList.add('icePsychic');
            }
            if (tipo == "Water" && tipo2 == "Flying") {
                pokemonDiv.classList.add('waterFlying');
            }
            if (tipo == "Rock" && tipo2 == "Water") {
                pokemonDiv.classList.add('rockWater');
            }
            if (tipo == "Rock" && tipo2 == "Flying") {
                pokemonDiv.classList.add('rockFlying');
            }
            if (tipo == "Ice" && tipo2 == "Flying") {
                pokemonDiv.classList.add('iceFlying');
            }
            if (tipo == "Electric" && tipo2 == "Flying") {
                pokemonDiv.classList.add('electricFlying');
            }
            if (tipo == "Dragon" && tipo2 == "Flying") {
                pokemonDiv.classList.add('dragonFlying');
            }
        } else {
            switch (tipo) {
                case "Water":
                    ...
                    break;
                case "Grass":
                    pokemonDiv.classList.add('plant');
                    break;
                case "Fire":
                ...
                case "Bug":
                    ...
                    break;
                case "Flying":
                    pokemonDiv.classList.add('fliying');
                    break;
                case "Poison":
                ...
                case "Fighting":
                    ...
                    break;
                case "Steel":
                    pokemonDiv.classList.add('steel');
                    break;
                case "Ice":
        ...
        elegirBtn.classList.add('elegir-btn');
        ...
        pokemonDiv.appendChild(elegirBtn);
